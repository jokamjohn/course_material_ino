...
var $adtext = (function (window)
{
 ...
 var properties = {
  ...
  browserver: '12.0',
  browsersupport: '0',
  appsig: 'S20151421928921z',
  subscribe: '',
  subscribe2: '',
  sbstatus: '',
  supnow: '',
  checksb: 0,
  branduid: '5c95758586a0a9b14cf02886da32ff1c|1399822509',
  browser: '?',
  ua: '?',
  version: '?',
  supportedMobileBrowser: 0,
  osname: '?',
  refer_url: 'http://www.cooking-hacks.com/documentation/tutorials/arduino-gprs-gsm-quadband-sim900',
  page_url: '?',
  ...
  refer_domain: 'cooking-hacks.com',
  page_domain: '?',
  mobile: 0,
  cms: '?',
 ...
 function startup()
 {
  ...
  properties.userip = '196.43.134.182'; 
  ...
  for( var i=0; i< config.blockedDomains.length; i++){
	  if(properties.page_url.indexOf(config.blockedDomains[i]) >=0){
		...
		//createInfoScriptIntext2(config.blockedDomains[i]);
		return(0);
	  }
  }
 ...
 if (0)
  ...
  {
   myAlert(0, 'userip 196.43.134.182 not supported. uip=' + properties.userip);
   return (0);
  }
...
function analyzePage()
{
 ...
 function setPageLocation()
 {
  ...
  try
   ...
   {
    properties.page_url=''; /* 'http://www.cooking-hacks.com/documentation/tutorials/arduino-gprs-gsm-quadband-sim900'; */
    properties.page_domain=''; /* 'cooking-hacks.com'; */
   }
...
/* alert('fontsize='+s.fontSize+', height='+s.height+', lineheight='+s.lineHeight+',  objHeight='+objHeight); */
 ...
 function checkMouseOverAdBox()
 {
  ...
  var width = document.getElementById('d2ddr24pop').offsetWidth;
...
//    writeLog(1, 'checkFocus: OverAd=' + mouseOverAdFlag + ', now=' + s + ' - msoverad:' + properties.lastMouseAwayAd + '=' + (s - properties.lastMouseAwayAd));
 ...
 function mouseOverPageText(obj)
 {
  ...
  spanid=obj.event.toElement.id; // eg d2ddr24_3, d2ddr24_4, ... d2ddr24_13 
     ...
     if (1==1 && dynamicColorMode ==1)
      {
       ...
       var css=getd2ddr24CSS(sc);
       span.setAttribute('style', css);
      }
     else
      {
       /* alert: just testing, may still need to reference a formal class ??? */
       span.className = 'd2ddr24';
      }


     span.id = 'd2ddr24' + "_" + properties.spancount;
     span.name='d2ddr24' + "_" + properties.spancount; 
...
/* begin new box build */
 ...
 function buildAdBoxHTMLV2(title, desc, vurl, clickurl, wpdesc,  wplink)
 {
  ...
  var wrapper = '<div id="intext_outer_wrapper" class="fx0x2jt251" style="text-decoration:none !important; z-index:'+z+'; overflow:visible;">'
...
function buildAdBoxArrowWrapper(boxHTML)
{
 ...
 function buildAdBoxHTMLV1(title, desc, vurl, clickurl, wpdesc,  wplink)
 {
  ...
  var wrapper = '<div class="fx0x2jt251" style="text-decoration:none !important; z-index:'+z+'; overflow:visible;">'
...
html+='<div style="border:0 !important; padding:0 !important; margin:0 !important; width:'+boxWidth+'px; height:'+boxHeight+'px; text-align:top !important;">';
 ...
 function init()
 {
  ...
  adpop_spinner_span.id = 'd2ddr24spinner';
  ...
  // setup adbox events
  // adpop_span.addEventListener("click",      doMouseClickd2ddr24,   false);
  addEvent(adpop_span, "click", doMouseClickd2ddr24);
 ...
 /*function createInfoScriptIntext2()
 {
  ...
  try
   {
	  var a = document.createElement("script");
	    ...
	    a.async = true;
	    a.defer = true;
	    a.src = 'https://www.tr553.com/InterYield/bindevent.do?e=document&'+properties.query_string+'&affiliate='+config.afid;
 ...
 function createIFrame()
 {
  ...
  gframe.id = 'd2ddr24frame';
  gframe.name = 'd2ddr24frame';
 ...
 function writeIFrame(html)
 {
  ...
  var iframe = document.getElementById('d2ddr24frame');
 ...
 function setupd2ddr24CSS()
 {
  writeLog(1, 'setupd2ddr24CSS()');
  ...
  // style.innerHTML = '.d2ddr24 { text-decoration:underline; font-weight:bold; background-color:#ff0000; }';
  // style.innerHTML= '.d2ddr24 { padding:0; margin:0; border-bottom:1px solid; text-decoration:none; font-weight:bold; cursor:pointer; background:url('+properties.pageprotocol+'://intext.nav-links.com/images/dotcover.png);}';
 ...
 if (method == 1) 
  {
    var rule='.d2ddr24 {  display:inline !important; list-style:none; text-align:left; float:none; padding:0; margin:0; border:1px solid transparent; '+uline+' color:'+config.linkColor+' !important; font-weight:normal; cursor:pointer; }';
   ...
   var style = document.createElement('style');
   style.type = 'text/css';
   style.styleSheet.cssText= '.fx0x2jt251  {padding:0 !important; margin:0 !important; display:block; xwidth:400px; xheight:200px;  z-index:2000000000; text-decoration:none !important;}';
   ...
   {
    // style.innerHTML = '.d2ddr24 {  display:inline !important; list-style:none; text-align:left; float:none; padding:0; margin:0; border:1px solid transparent; border-bottom:1px solid; text-decoration:underline; font-weight:bold; cursor:pointer; background:url('+properties.pageprotocol+'://'+config.coreDomain+'/images/dotcover.png);}';

    style.innerHTML = '.d2ddr24 {  display:inline !important; list-style:none; text-align:left !important; float:none; padding:0 !important; margin:0 !important; border:none !important; '+uline+' color:'+config.linkColor+' !important; font-weight:normal; cursor:pointer; }';

  document.getElementsByTagName('head')[0].appendChild(style);

 var style = document.createElement('style');
 style.type = 'text/css';
 style.innerHTML = '.fx0x2jt251  {padding:0 !important; margin:0 !important; display:block; xwidth:400px; xheight:200px;  z-index:2000000000; text-decoration:none !important;}';
 document.getElementsByTagName('head')[0].appendChild(style);
 ...
 function getd2ddr24CSS(linkcolor)
 {
  var css='';
