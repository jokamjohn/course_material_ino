...
void sendToPowerlog(String a, String b, String c){
...
//  ShowSerialData();
  ...
  mySerial.println("AT+CIPSTART=\"TCP\",\"www.internship.elfbay.com\",\"80\"");//start up the connection
  delay(5000); 
  ShowSerialData();
  delay(5000);
  ShowSerialData();
  ...
  mySerial.print("PUT /index.php/update_power?");//here is the feed you apply from pachube
  delay(1000);
  ShowSerialData();
  
  mySerial.print("entry_id=");   //DATA feed name
  mySerial.print(a);   //DATA to send
  delay(50);
  ShowSerialData();
  
  mySerial.print("&current=");   //DATA feed name
  mySerial.print(b);   //DATA to send
  delay(50);
  ShowSerialData();
 
  mySerial.print("&voltage=");   //DATA feed name
  mySerial.print(c);   //DATA to send
  delay(50);
  ShowSerialData();
  ...
  mySerial.print("Host: www.internship.elfbay.com\r\n");
  delay(1000);
  ShowSerialData();
  delay(2000);
    ShowSerialData();
